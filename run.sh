...
# mlir-opt benchmarks/matmul_affine.mlir \
#     --affine-loop-tile="tile-sizes=32,64,38" \
#     --canonicalize \
#     --cse \
#     -o benchmarks/matmul_tiled.mlir
    
# polygeist-opt benchmarks/matmul_tiled.mlir --lower-affine | mlir-opt --convert-scf-to-cf | mlir-opt --convert-to-llvm | mlir-opt \
#     --reconcile-unrealized-casts | mlir-translate --mlir-to-llvmir -o benchmarks/matmul.ll